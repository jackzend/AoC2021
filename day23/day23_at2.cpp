...
void checkHallway( vector<Move> &ret, const game_state_t &gs )
{
   for ( int col = 0; col < gs[1].size(); ++col )       // row one, checking for guys in the hallway
   {
      ...
      switch ( gs[1][col] )
      {
         case A_t:
            ...
            if ( getSpotType( A_ROOM_1, gs ) == EMPTY and getSpotType( A_ROOM_2, gs ) == EMPTY )
            {
               cout << "Made it Here" << endl;
            ...
            else if ( getSpotType( A_ROOM_2, gs ) == A_t and getSpotType( A_ROOM_1, gs ) == EMPTY )
            {// else if spot 2 has an A, run dfs to spot_1
         ...
         case B_t:
            // if both spots empty, run dfs to spot_2
            if ( getSpotType( B_ROOM_1, gs ) == EMPTY and getSpotType( B_ROOM_2, gs ) == EMPTY )
            {
               cout << "Made it Here" << endl;
               ...
               if ( check.first )
               {
                  cout << "Move to B home in " << check.second << " steps" << endl;
            ...
            else if ( getSpotType( B_ROOM_2, gs ) == B_t and getSpotType( B_ROOM_1, gs ) == EMPTY )
            {// else if spot 2 has a B, run dfs to spot_1
               auto check = quickDfs( start_space, B_ROOM_1, gs );
               if ( check.first )
               {
                  cout << "Move to B home into the first slot in " << check.second << " steps" << endl;
         ...
         case C_t:
            // if both spots empty, run dfs to spot_2
            if ( getSpotType( C_ROOM_1, gs ) == EMPTY and getSpotType( C_ROOM_2, gs ) == EMPTY )
            {
               cout << "Made it Here" << endl;
               ...
               if ( check.first )
               {
                  cout << "Move to C home in " << check.second << " steps" << endl;
            ...
            else if ( getSpotType( C_ROOM_2, gs ) == C_t and getSpotType( C_ROOM_1, gs ) == EMPTY )
            {// else if spot 2 has a B, run dfs to spot_1
               auto check = quickDfs( start_space, C_ROOM_1, gs );
               if ( check.first )
               {
                  cout << "Move to C home into the first slot in " << check.second << " steps" << endl;
         ...
         case D_t:
            // if both spots empty, run dfs to spot_2
            if ( getSpotType( D_ROOM_1, gs ) == EMPTY and getSpotType( D_ROOM_2, gs ) == EMPTY )
            {
               cout << "Made it Here" << endl;
               ...
               if ( check.first )
               {
                  cout << "Move to D home in " << check.second << " steps" << endl;
            ...
            else if ( getSpotType( D_ROOM_2, gs ) == D_t and getSpotType( D_ROOM_1, gs ) == EMPTY )
            {// else if spot 2 has a B, run dfs to spot_1
               auto check = quickDfs( start_space, D_ROOM_1, gs );
               if ( check.first )
               {
                  cout << "Move to D home into the first slot in " << check.second << " steps" << endl;
   ...
   for ( int r = 2; r < gs.size() - 1; ++r )
   {
      for ( int c = 0; c < gs[r].size(); ++c )
      {
         if ( gs[r][c] != EMPTY and gs[r][c] != OB and gs[r - 1][c] == EMPTY ) // must have empty space above otherwise dont bother
         {
            ...
            {
               case A_t:
                  if ( start_spot == A_ROOM_1 and getSpotType( A_ROOM_2, gs ) == A_t ) // its filled
                  {
                     cout << "A room Filled" << endl;
                     continue;
                  }
                  if ( start_spot == A_ROOM_2 ) // A's below it all the way down
                  {
               ...
               case B_t:
                  ...
                  {
                     cout << "B room Filled" << endl;
                     continue;
                  }
                  if ( start_spot == B_ROOM_2 )
                  {
                     cout << "B in spot 2 of A room will stay put" << endl;
                     continue;
                  }
               ...
               case C_t:
                  ...
                  {
                     cout << "C room Filled" << endl;
                     continue;
                  }
                  if ( start_spot == C_ROOM_2 )
                  {
                     cout << "C in spot 2 of C room will stay put" << endl;
                     continue;
                  }
               ...
               case D_t:
                  ...
                  {
                     cout << "D room Filled" << endl;
                     continue;
                  }
                  if ( start_spot == D_ROOM_2 )
                  {
                     cout << "D in spot 2 of D room will stay put" << endl;
                     continue;
                  }
